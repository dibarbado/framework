...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h2>PRODUTOS</h2>
            <button class="btn btn-primary pull-right btn-crud" data-title="ADICIONAR PRODUTO" data-url="<?= Utils::link('products','add'); ?>">
                <span class="glyphicon glyphicon-plus"></span>
            </button>
            <br>
            <table class="table table-hover table-to-datatables" data-ajax="<?= Utils::link('products','datatables'); ?>">
                <thead>
                    <tr>
                        <th>NOME</th>
                        <th>PREÇO</th>
